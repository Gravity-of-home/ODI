...
const SvgDepartureMarker = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns='http://www.w3.org/2000/svg' fill='none' viewBox='0 0 24 63' {...props}>
    <path
      fill='#E0E0E0'
      fillRule='evenodd'
...
export default SvgDepartureMarker;
